...
subscribedCommunities, subscribe, unsubscribe , getUserById } = require('../controllers/userControllers')
...
userRouter.get('/own', authMiddleware, getUserById) // Get logged in user's information by checking Auth Headers for userId
